...
[data-tab].active.tab-active\:bg-gradient-to-tr {
...
[data-tab].active > .group-active\:text-white {
  --tw-text-opacity: 1;
  color: rgb(255 255 255 / var(--tw-text-opacity));
}
...
select{
  ...
  -moz-appearance: none;
  appearance: none;
  background: transparent url("https://pagedone.io/asset/uploads/1695813759.png") no-repeat 95% center;
}
